...
traffic out of your capture" below.10. **Per-IP tags and colors.** Right-click an address in the capture table
...
can be slow. When on, IPs in the table are replaced by hostnames (the raw IPstays in the tooltip); when off, you see raw IPs.
...
the main capture even though the rest of the flow is correctly diverted; aSYN scan or a Crafter send is fully reliable since Network Companion
...
 ## Scope and intent For authorised use: your own hosts, your own segment, your lab, and IDS /
